            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="conf_user.php" class="nav-link active">
                                ...
                                <form id="add-form" method="post" action="conf_update.php" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" autocomplete="off" name="id_admin" id="id_admin" value="<?php echo $_SESSION['id_admin']; ?>" class="form-control">
                                            <input type="text" autocomplete="off" name="username" id="username" value="<?php echo $_SESSION['username']; ?>" class="form-control">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
